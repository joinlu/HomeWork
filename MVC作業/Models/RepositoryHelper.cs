namespace MVC作業.Models
{
	public static class RepositoryHelper
	{
		...
		public static UserListViewRepository GetUserListViewRepository()
		{
			var repository = new UserListViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static UserListViewRepository GetUserListViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new UserListViewRepository();
